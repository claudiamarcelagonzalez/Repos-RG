...
presencia <- read_delim("/Users/claudiamgonzalez/Documents/INV/DATOS/Repositorios-RG/2017_12_7/Tabla_datos_RG_y_RIS_actualizada.csv", 
    ";", escape_double = FALSE, trim_ws = TRUE)
...
presencia$Sex <- as.factor(presencia$Sexo)
presencia$Cat <- as.factor(presencia$Categoria)
presencia$Ed <- as.factor(presencia$Edad)
presencia$RG <-  as.factor(presencia$ResearchGate)
presencia$Repos <- as.factor(presencia$Repos)
